...
@section('header')
    @include('dashboard.partials.__header', [
        ...
        'subname' => __('site.add'),
        'subRoute' => route('dashboard.users.create'),
    ])
@endsection

@section('content')
    <div class="card py-3 px-3">
        <form class="needs-validation" action="{{ route('dashboard.users.store') }}" method="POST"
            ...
            <div class="form-row">
                <div class="col-xl-6 mb-3">
                    ...
                    <input type="text" name="first_name" class="form-control" id="validationTooltip01"
                        placeholder="{{ __('site.first_name') }}" value="{{ old('first_name', '') }}">
                    @error('first_name')
                ...
                <div class="col-xl-6 mb-3">
                    ...
                    <input type="text" name="last_name" class="form-control" id="validationTooltip02"
                        placeholder="{{ __('site.last_name') }}" value="{{ old('last_name', '') }}">
                    @error('last_name')
                        <span class="text-danger" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="col-xl-12 mb-3">
                    <img width="100px" src="{{ asset('uploads/users_images/default.png') }}" class="image-preview" alt="user image">
                </div>
                <div class="col-xl-6 mb-3">
